 ...
 */
public class UserTeacherAdd extends MyRoute {
    @Override
    public Object myHandle(Request request, Response response) throws Exception {
        ...
        if (!resultSetAdmin.next()) {
            ...
            PreparedStatement preparedStatement2 = DBManager.getConnection().prepareStatement("INSERT INTO teachers(level) VALUES(?)");
            preparedStatement2.setInt(1, json.getInt("level"));
