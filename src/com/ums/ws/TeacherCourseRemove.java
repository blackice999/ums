...
public class TeacherCourseRemove extends MyRoute {
    ...
    public Object myHandle(Request request, Response response) throws Exception {
        ...
        if (!resultSetAdmin.next()) {
            ...
            PreparedStatement preparedStatement = DBManager.getConnection().prepareStatement("DELETE FROM teachers_courses WHERE teachers_id = ? AND courses_id = ?", Statement.RETURN_GENERATED_KEYS);
